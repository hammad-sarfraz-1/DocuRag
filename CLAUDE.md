...
- No emojis in source files, comments, docstrings, log/print statements, commit messages, or test output.
- Use plain ASCII status words instead (e.g. "OK", "FAIL", "WARN", "DONE").
